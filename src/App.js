...
export default function App() {
  ...
  //     nickName: "Bharti",
  //     pic:
  //       "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSuPyLBCLuRQ2EMf1Tdz8GRtdsy2KAGUcZgAg&usqp=CAU"
  //   },
  //   {
  //     nickName: "Shivam",
  //     pic:
  //       "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTlGf1LsCO_POD_MWK0T40UPrQZfYOjgU0SvQ&usqp=CAU"
  //   }
  // ];
  const movies = [
    {
